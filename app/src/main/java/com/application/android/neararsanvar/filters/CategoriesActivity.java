...
public class CategoriesActivity extends BaseActivity {
    ...
    private static final int SUBCATEGORY_REQ_CODE = 1;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == SUBCATEGORY_REQ_CODE && resultCode == Activity.RESULT_OK) {
            //Log.i("log-", "BURAYA GELDİ");
    ...
    void queryCategories() {
        showLoading(CategoriesActivity.this);
    ...
    private void startSubcategoriesScreen(List<ParseObject> subcategoriesObjects) {
        ...
        //subcategoriesIntent.putExtra(SubcategoriesActivity.SELECTED_CATEGORY, selectedCategory);
        ...
        startActivityForResult(subcategoriesIntent, SUBCATEGORY_REQ_CODE);
    }
}
