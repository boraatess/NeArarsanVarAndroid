...
-------------------------------*/
public class MyLikesActivityAdapter extends RecyclerView.Adapter<MyLikesActivityAdapter.MyLikesVH> {

    private List<ParseObject> likesObjects;
    private MyLikesClickListener myLikesClickListener;

    public MyLikesActivityAdapter(List<ParseObject> likesObjects, MyLikesClickListener myLikesClickListener) {
