...
import com.application.android.neararsanvar.home.fragments.AdListFragment;
...
-------------------------------*/
public class AdsListScreenPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public AdsListScreenPagerAdapter(FragmentManager fm) {
        super(fm);
    }
