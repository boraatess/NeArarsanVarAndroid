package com.application.android.neararsanvar.wizard;
...
import com.application.android.neararsanvar.landing.LoginActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "Google ile giriş yapmak yakında aktif olacaktır.", Toast.LENGTH_LONG).show();
        ...
        facebookBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v)
            {
                Toast.makeText(getApplicationContext(), "Facebook ile giriş yapmak yakında aktif olacaktır.", Toast.LENGTH_LONG).show();
                ...
                //                        showLoading(WizardActivity.this);
////
...
//
        ...
        TextView tosButt = findViewById(R.id.tosButt);
    ...
    private void initViews() {
        ...
        googleBtn = findViewById(R.id.googleButt);
