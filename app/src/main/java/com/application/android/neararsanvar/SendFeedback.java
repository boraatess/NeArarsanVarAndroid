    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sButt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                starNr = 1;
                sButt1.setBackgroundResource(R.drawable.fullstars);
                sButt2.setBackgroundResource(R.drawable.empty_stars);
                sButt3.setBackgroundResource(R.drawable.empty_stars);
                sButt4.setBackgroundResource(R.drawable.empty_stars);
                sButt5.setBackgroundResource(R.drawable.empty_stars);
            }
        });
        sButt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                starNr = 2;
                sButt1.setBackgroundResource(R.drawable.fullstars);
                sButt2.setBackgroundResource(R.drawable.fullstars);
                sButt3.setBackgroundResource(R.drawable.empty_stars);
                sButt4.setBackgroundResource(R.drawable.empty_stars);
                sButt5.setBackgroundResource(R.drawable.empty_stars);
            }
        ...
        sButt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sButt1.setBackgroundResource(R.drawable.fullstars);
                sButt2.setBackgroundResource(R.drawable.fullstars);
                sButt3.setBackgroundResource(R.drawable.fullstars);
                sButt4.setBackgroundResource(R.drawable.empty_stars);
                sButt5.setBackgroundResource(R.drawable.empty_stars);
            }
        });
        sButt4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sButt2.setBackgroundResource(R.drawable.fullstars);
                sButt3.setBackgroundResource(R.drawable.fullstars);
                sButt4.setBackgroundResource(R.drawable.fullstars);
                sButt5.setBackgroundResource(R.drawable.empty_stars);
            }
        });
        sButt5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sButt3.setBackgroundResource(R.drawable.fullstars);
                sButt4.setBackgroundResource(R.drawable.fullstars);
                sButt5.setBackgroundResource(R.drawable.fullstars);
            }
        });
