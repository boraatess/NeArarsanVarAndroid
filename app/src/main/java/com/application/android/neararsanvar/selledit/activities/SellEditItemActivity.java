package com.application.android.neararsanvar.selledit.activities;
...
import com.application.android.neararsanvar.BuildConfig;
...
import com.application.android.neararsanvar.databinding.ActivitySellEditBinding;
...
import com.application.android.neararsanvar.filters.SubcategoriesActivity;
...
public class SellEditItemActivity extends BaseActivity {
    ...
    private static final int SELECT_CITY_REQ_CODE = 111;
    ...
    ActivitySellEditBinding binding;
    Activity activity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        activity = this;
        binding = DataBindingUtil.setContentView(activity, R.layout.activity_sell_edit);
        ...
        binding.tvSell.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //TODO : POSITION 1 FOR LEFT CORNER BG
                cleareBg(binding.tvSell, 1);
                condition = "Sell";
        ...
        binding.tvRent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                cleareBg(binding.tvRent, 0);
                condition = "Rent";
                priceET.setVisibility(View.VISIBLE);
                imageType.setVisibility(View.GONE);
        ...
        binding.tvExchange.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                cleareBg(binding.tvExchange, 0);
                imageType.setVisibility(View.VISIBLE);
                imageType.setImageResource(R.drawable.exchange);
                priceET.setVisibility(View.INVISIBLE);
                condition = "Exchange";
            }
        });

        binding.tvGift.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //TODO : POSITION 2 FOR RIGHT CORNER BG
                cleareBg(binding.tvGift, 2);
                imageType.setVisibility(View.VISIBLE);
                imageType.setImageResource(R.drawable.gift);
                priceET.setVisibility(View.INVISIBLE);
                condition = "Gift";
            }
        });
...
//              //          Reset variables and image
    ...
    private void initViews() {
        ...
        locationLL = findViewById(R.id.ase_city_ll);
    ...
    private void setUpViews() {
       ...
       /* conditionRG.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
        ...
        locationLL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent cityIntent = new Intent(SellEditItemActivity.this, CityActivity.class);
                cityIntent.putExtra(CityActivity.SELECTED_CITIES_EXTRA_KEY, selectedCity);
                cityIntent.putExtra(CityActivity.HAS_FILTER_ROLE_EXTRA_KEY, false);
                startActivityForResult(cityIntent, SELECT_CITY_REQ_CODE);
            }
        });
       ...
       /* locationLL.setOnClickListener(new View.OnClickListener() {
        ...
        doneIV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (addImage1IV.getVisibility() == View.VISIBLE || addImage2IV.getVisibility() == View.VISIBLE ||
                        addImage3IV.getVisibility() == View.VISIBLE) {
                    checkImageLoad = true;
                } else {
                ...
                if (!checkImageLoad || TextUtils.isEmpty(titleET.getText()) ||
    ...
    private void submitAd() {
        ...
        adObj.put(Configs.ADS_CITIES, selectedCity);
        ...
        if (condition == "Gift" || condition == "Exchange") {
            adObj.put(Configs.ADS_PRICE, 0);
        }
        else{
...
//
        ...
        // Get details
        selectedCity = adObj.getString(Configs.ADS_CITIES);
...
//
    ...
    public void cleareBg(TextView view, int pos) {

        binding.tvSell.setTextColor(ContextCompat.getColor(activity, R.color.darkGrayTextColor));
        binding.tvRent.setTextColor(ContextCompat.getColor(activity, R.color.darkGrayTextColor));
        binding.tvExchange.setTextColor(ContextCompat.getColor(activity, R.color.darkGrayTextColor));
        binding.tvGift.setTextColor(ContextCompat.getColor(activity, R.color.darkGrayTextColor));
        view.setTextColor(ContextCompat.getColor(activity, R.color.white));

        binding.tvSell.setBackground(null);
        binding.tvRent.setBackground(null);
        binding.tvExchange.setBackground(null);
        binding.tvGift.setBackground(null);

        //TODO : SET PRICE IF GIFT OR EXCHANGE SET 0.00
        priceET.setText("");
        priceET.setEnabled(true);

        if (pos == 1) {
            view.setBackgroundResource(R.drawable.left_round_corner);
        } else if (pos == 2) {
            view.setBackgroundResource(R.drawable.right_round_corner);
        } else {
            view.setBackgroundResource(R.drawable.fill_corner);
        }
