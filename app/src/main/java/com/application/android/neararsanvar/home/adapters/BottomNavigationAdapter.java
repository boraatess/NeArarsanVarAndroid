...
import com.application.android.neararsanvar.home.enums.BottomNavigationTab;
...
public class BottomNavigationAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == REGULAR_ITEM_VIEW_TYPE) {
            ...
            lp.width = width;
            lp.topMargin = UIUtils.getDimension(R.dimen.bottom_navigation_view_height) - UIUtils.getDimension(R.dimen.bottom_navigation_clickable_area);
