...
public class AdImagesPagerAdapter extends PagerAdapter
{
    ...
    public AdImagesPagerAdapter(ParseObject adObject, OnImageClickListener onImageClickListener,ArrayList<String> arrayList) {
                ...
                imageIV.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (onImageClickListener != null) {
                            onImageClickListener.onImageClicked(position,arrayList.get(position));
                        }
                    }
                });
            }
    ...
    public interface OnImageClickListener {
        ...
        void onImageClicked(int pos,String imageFieldKey);
    }
}
